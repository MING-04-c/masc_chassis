...
#include "masc_chassis_msgs/msg/detail/rc_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const masc_chassis_msgs::msg::RcStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  masc_chassis_msgs::msg::RcStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = masc_chassis_msgs::msg::RcStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_masc_chassis_msgs
max_serialized_size_key_RcStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const masc_chassis_msgs::msg::RcStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<masc_chassis_msgs::msg::RcStatus *>(
    untyped_ros_message);
...
static size_t _RcStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_RcStatus(full_bounded, is_plain, 0);
...
{
  return &masc_chassis_msgs::msg::typesupport_fastrtps_cpp::_RcStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, masc_chassis_msgs, msg, RcStatus)() {
  return &masc_chassis_msgs::msg::typesupport_fastrtps_cpp::_RcStatus__handle;
}
