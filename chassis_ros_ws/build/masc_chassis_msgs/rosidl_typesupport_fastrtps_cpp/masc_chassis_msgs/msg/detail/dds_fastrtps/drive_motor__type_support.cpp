...
#include "masc_chassis_msgs/msg/detail/drive_motor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const masc_chassis_msgs::msg::DriveMotor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  masc_chassis_msgs::msg::DriveMotor & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = masc_chassis_msgs::msg::DriveMotor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const masc_chassis_msgs::msg::DriveMotor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<masc_chassis_msgs::msg::DriveMotor *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DriveMotor__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const masc_chassis_msgs::msg::DriveMotor *>(
...
static size_t _DriveMotor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DriveMotor(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DriveMotor__callbacks = {
...
static rosidl_message_type_support_t _DriveMotor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DriveMotor__callbacks,
...
{
  return &masc_chassis_msgs::msg::typesupport_fastrtps_cpp::_DriveMotor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, masc_chassis_msgs, msg, DriveMotor)() {
  return &masc_chassis_msgs::msg::typesupport_fastrtps_cpp::_DriveMotor__handle;
}
