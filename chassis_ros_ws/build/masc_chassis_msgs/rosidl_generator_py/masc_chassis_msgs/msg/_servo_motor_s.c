...
bool masc_chassis_msgs__msg__servo_motor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("masc_chassis_msgs.msg._servo_motor.ServoMotor", full_classname_dest, 45) == 0);
  }
  masc_chassis_msgs__msg__ServoMotor * ros_message = _ros_message;
  {  // header
  ...
  {  // calibration_state
    ...
    assert(PyLong_Check(field));
    ros_message->calibration_state = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // angle
...
{
  /* NOTE(esteve): Call constructor of ServoMotor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("masc_chassis_msgs.msg._servo_motor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoMotor");
