...
bool masc_chassis_msgs__msg__rc_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("masc_chassis_msgs.msg._rc_status.RcStatus", full_classname_dest, 41) == 0);
  }
  masc_chassis_msgs__msg__RcStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // channels
    ...
    }
    {
      ...
      Py_ssize_t size = 7;
      int8_t * dest = ros_message->channels;
...
PyObject * masc_chassis_msgs__msg__rc_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("masc_chassis_msgs.msg._rc_status");
  ...
  {  // channels
    ...
    int8_t * src = &(ros_message->channels[0]);
    memcpy(dst, src, 7 * sizeof(int8_t));
    Py_DECREF(field);
  }
