...
static const _ServoMotorArray_type_support_symbol_names_t _ServoMotorArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, masc_chassis_msgs, msg, ServoMotorArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, masc_chassis_msgs, msg, ServoMotorArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, masc_chassis_msgs, msg, ServoMotorArray)() {
  return &::masc_chassis_msgs::msg::rosidl_typesupport_c::ServoMotorArray_message_type_support_handle;
}
