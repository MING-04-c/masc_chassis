...
class Metaclass_ServoMotorStatus(type):
    """Metaclass of message 'ServoMotorStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__servo_motor_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__servo_motor_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__servo_motor_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__servo_motor_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__servo_motor_status
...
class ServoMotorStatus(metaclass=Metaclass_ServoMotorStatus):
    """Message class 'ServoMotorStatus'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.driver_fault = kwargs.get('driver_fault', int())
    ...
    def motor_temperature(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'motor_temperature' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def driver_temperature(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'driver_temperature' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def driver_fault(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'driver_fault' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'driver_fault' field must be an unsigned integer in [0, 4294967295]"
