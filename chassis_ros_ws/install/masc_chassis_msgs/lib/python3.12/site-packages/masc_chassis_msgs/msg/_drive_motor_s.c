...
bool masc_chassis_msgs__msg__drive_motor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("masc_chassis_msgs.msg._drive_motor.DriveMotor", full_classname_dest, 45) == 0);
  }
  masc_chassis_msgs__msg__DriveMotor * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DriveMotor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("masc_chassis_msgs.msg._drive_motor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DriveMotor");
